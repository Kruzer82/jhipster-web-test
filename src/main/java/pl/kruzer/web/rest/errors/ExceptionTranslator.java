...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        pl.kruzer.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        pl.kruzer.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleInvalidPasswordException(pl.kruzer.service.InvalidPasswordException ex, NativeWebRequest request) {
