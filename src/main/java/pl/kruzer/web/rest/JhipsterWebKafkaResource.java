...
@RestController
@RequestMapping("/api/jhipster-web-kafka")
public class JhipsterWebKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterWebKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterWebKafkaResource(KafkaProperties kafkaProperties) {
