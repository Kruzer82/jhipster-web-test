...
class JhipsterWebKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterWebKafkaResource kafkaResource = new JhipsterWebKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-web-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-web-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
